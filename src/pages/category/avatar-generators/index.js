  ...
  return (
    <>
      <div className="container">
        <header className="h-55 mb-5 p-12 bg-white text-[#2f4468] font-[600] text-4xl border border-gray-300 rounded-md my-5 ">
                  ...
                  <div className="pl-4">
                    ...
                    <p className="mb-5">
                      <button className="text-white bg-[#2872fa] hover:bg-blue-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 text-base rounded-sm px-5 py-3 flex">
                        <Link href={"/category/avatar-generators/" + post.slug}>
                          Read more
                        </Link>
                        <svg
                          width="20px"
